...
#define TRACKPAD_SCROLL_SENSITIVITY 0.016f // two-finger scroll speed (−20% from 0.02; patch default 0.10)
#define TRACKPAD_SCROLL_DECAY 0.905f       // momentum coast length (~−60% coast vs 0.96; patch default 0.95)
